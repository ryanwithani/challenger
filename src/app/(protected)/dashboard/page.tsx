...
export default async function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cozy-cream to-brand-100 dark:from-gray-900 dark:to-gray-900">
      <div className="max-w-[1400px] mx-auto p-6 space-y-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border-2 border-gray-100 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold bg-gradient-to-r from-brand-500 to-accent-500 dark:from-brand-600 dark:to-accent-600 bg-clip-text text-transparent">
                Dashboard
              </h1>
