                                ...
                                <label
                                    ...
                                    className={`p-4 border-2 rounded-xl cursor-pointer transition-all ${
                                        watchedValues.start_type === option.value
                                            ...
                                            : 'border-gray-200 hover:border-gray-300 dark:border-warmGray-700 dark:hover:border-warmGray-700'
                                    }`}
                                >
                                    <input
                                        type="radio"
                                    ...
                                    <div className="text-center">
                                        <div className="font-semibold text-gray-900 dark:text-warmGray-100 mb-1">{option.label}</div>
                                        ...
                                        <div className="text-sm text-gray-600 dark:text-warmGray-200 mb-2">{option.description}</div>
                                        <div className="text-xs text-gray-500 dark:text-warmGray-300">{option.detail}</div>
                                        {option.bonus > 0 && (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                                    {LEGACY_RULES.genderLaw.map((law) => (
                                        <label key={law.value} className={`p-3 border rounded-xl cursor-pointer transition-all ${
                                            watchedValues.gender_law === law.value ? 'border-brand-500 bg-brand-500/5 dark:bg-brand-500/10' : 'border-gray-200 hover:border-gray-300 dark:border-warmGray-700 dark:hover:border-warmGray-700'
                                        }`}>
                                            <input
                                                type="radio"
                                                {...register('gender_law')}
                                                ...
                                                className="sr-only"
                                            />
                                            <div className="font-medium text-gray-900 dark:text-warmGray-100 mb-1">{law.label}</div>
                                            <div className="text-sm text-gray-600 dark:text-warmGray-200">{law.desc}</div>
                                        </label>
                                    ))}
                                </div>
                            </CollapsibleContent>
                            ...
                            <CollapsibleContent>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                                    {LEGACY_RULES.bloodlineLaw.map((law) => (
                                        <label key={law.value} className={`p-3 border rounded-xl cursor-pointer transition-all ${
                                            watchedValues.bloodline_law === law.value ? 'border-brand-500 bg-brand-500/5 dark:bg-brand-500/10' : 'border-gray-200 hover:border-gray-300 dark:border-warmGray-700 dark:hover:border-warmGray-700'
                                        }`}>
                                            <input
                                                type="radio"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                                    {LEGACY_RULES.heirSelection.map((method) => (
                                        <label key={method.value} className={`p-3 border rounded-xl cursor-pointer transition-all ${
                                            watchedValues.heir_selection === method.value ? 'border-brand-500 bg-brand-500/5 dark:bg-brand-500/10' : 'border-gray-200 hover:border-gray-300 dark:border-warmGray-700 dark:hover:border-warmGray-700'
                                        }`}>
                                            <input
                                                type="radio"
                                                ...
                                                className="sr-only"
                                            />
                                            <div className="font-medium text-gray-900 dark:text-warmGray-100 mb-1">{method.label}</div>
                                            <div className="text-sm text-gray-600 dark:text-warmGray-200">{method.desc}</div>
                                        </label>
                                    ))}
                                </div>
                            </CollapsibleContent>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
                                    {LEGACY_RULES.speciesRule.map((rule) => (
                                        <label key={rule.value} className={`p-3 border rounded-xl cursor-pointer transition-all ${
                                            watchedValues.species_rule === rule.value ? 'border-brand-500 bg-brand-500/5 dark:bg-brand-500/10' : 'border-gray-200 hover:border-gray-300 dark:border-warmGray-700 dark:hover:border-warmGray-700'
                                        }`}>
                                            <input
                                                type="radio"
                                                ...
                                                className="sr-only"
                                            />
                                            <div className="font-medium text-gray-900 dark:text-warmGray-100 mb-1">{rule.label}</div>
                                            <div className="text-sm text-gray-600 dark:text-warmGray-200">{rule.desc}</div>
                                        </label>
                                    ))}
                                </div>
                            </CollapsibleContent>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
                                    {LEGACY_RULES.lifespan.map((lifespan) => (
                                        <label key={lifespan.value} className={`p-3 border rounded-xl cursor-pointer transition-all ${
                                            watchedValues.lifespan === lifespan.value ? 'border-brand-500 bg-brand-500/5 dark:bg-brand-500/10' : 'border-gray-200 hover:border-gray-300 dark:border-warmGray-700 dark:hover:border-warmGray-700'
                                        }`}>
                                            <input
                                                type="radio"
                                                {...register('lifespan')}
                                                ...
                                                className="sr-only"
                                            />
                                            <div className="font-medium text-gray-900 dark:text-warmGray-100 mb-1">{lifespan.label}</div>
                                            <div className="text-sm text-gray-600 dark:text-warmGray-200">{lifespan.desc}</div>
                                        </label>
                                    ))}
                                </div>
                            </CollapsibleContent>
