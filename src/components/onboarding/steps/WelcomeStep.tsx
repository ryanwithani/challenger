    ...
    <div className="p-8 md:p-12">
      ...
      <div className="max-w-2xl mx-auto space-y-4 mb-12">
        ...
        <div ref={optionsRef} className="grid md:grid-cols-2 gap-4">
          ...
          {/* Create a Sim */}
          <div
            className={`group border-2 rounded-xl p-6 hover:shadow-lg transition-all cursor-pointer bg-gradient-to-br from-white to-brand-50 dark:from-gray-800 dark:to-brand-900/30 ${selectedOption === 'sim'
              ? 'border-brand-500 dark:border-brand-400 shadow-lg'
              : 'border-gray-200 dark:border-gray-700 hover:border-brand-400 dark:hover:border-brand-500'
              }`}
