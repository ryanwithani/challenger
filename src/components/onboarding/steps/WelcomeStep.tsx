  ...
  return (
    <div className="p-8 md:p-12">
      ...
      <div className="max-w-2xl mx-auto space-y-4 mb-12">
        ...
        <div ref={optionsRef} className="grid md:grid-cols-2 gap-4">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-warmGray-100 mb-2">Start a Challenge</h3>
          ...
          >
            <div className="w-12 h-12 bg-brand-500 dark:bg-brand-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
            </div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-warmGray-100 mb-2">Create a Sim</h3>
            <p className="text-sm text-gray-600 dark:text-warmGray-200">
      ...
      <div className="max-w-2xl mx-auto mb-12">
        ...
        <div className="grid sm:grid-cols-3 gap-4 text-center">
          <div>
            ...
            <p className="text-sm font-medium text-gray-700 dark:text-warmGray-100">Track Goals</p>
            <p className="text-xs text-gray-500 dark:text-warmGray-300">Monitor your challenge progress</p>
          </div>
          <div>
            ...
            <p className="text-sm font-medium text-gray-700 dark:text-warmGray-100">Manage Sims</p>
            <p className="text-xs text-gray-500 dark:text-warmGray-300">Track families across generations</p>
          </div>
          <div>
            <div className="w-10 h-10 bg-brand-100 dark:bg-brand-900 rounded-lg flex items-center justify-center mx-auto mb-2">
            ...
            <p className="text-sm font-medium text-gray-700 dark:text-warmGray-100">Earn Points</p>
            <p className="text-xs text-gray-500 dark:text-warmGray-300">Complete goals and achievements</p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="mt-4 text-sm text-gray-500 dark:text-warmGray-300">
