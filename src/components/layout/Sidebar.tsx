...
export function Sidebar() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <div className="hidden lg:flex w-64 bg-warmGray-800 dark:bg-warmGray-900 border-r border-warmGray-700 dark:border-warmGray-800 flex-col transition-colors">
                  ...
                  <Link
                    ...
                    className={clsx(
                      'group flex items-center px-4 py-3 text-base font-medium rounded-lg transition-colors',
                      {
                        ...
                        'text-warmGray-400 hover:bg-warmGray-700 dark:hover:bg-warmGray-800 hover:text-warmGray-100': !isActive,
                      }
                    )}
                  >
                    <item.icon
        ...
        {/* User Section */}
        <div className="flex-shrink-0 flex border-t border-warmGray-700 dark:border-warmGray-800 p-5">
          <div className="flex items-center w-full">
            ...
            <Link
              href="/profile"
              aria-label="Settings"
              className="ml-2 p-2 rounded-lg text-warmGray-500 hover:text-warmGray-200 hover:bg-warmGray-700 dark:hover:bg-warmGray-800 transition-colors"
            >
